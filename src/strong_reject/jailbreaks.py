...
.. testcode::
    ...
    from src.strong_reject.jailbreaks import apply_jailbreaks
...
.. testcode::
    ...
    from src.strong_reject.jailbreaks import apply_jailbreaks_to_dataset
...
.. code-block::
    ...
    from src.strong_reject.jailbreaks import registered_jailbreaks
...
.. testcode::
    ...
    from src.strong_reject.jailbreaks import register_jailbreak
...
def pair(
    ...
    attack_models: tuple[str] = ("gpt-4o-mini", "nousresearch/hermes-3-llama-3.1-70b"),
    ...
    **kwargs,
    ...
    for _ in (progress_bar := tqdm(range(max_iter))):
        ...
        for attack_model in attack_models:
            ...
            log("Attacker: [green]", attacker_response, "[/green]")
            try:
        ...
        log("Victim: [dim]", victim_response, "[/dim]")
        score = evaluate(
